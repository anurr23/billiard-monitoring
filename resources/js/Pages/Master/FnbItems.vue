...
} = useDatatable(computed(() => props.items), ['name', 'category']);
                    ...
                    <div class="bb-card-body">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" v-model="form.price" required min="0" placeholder="Contoh: 15000" class="bb-input" :class="{'border-danger': form.errors.price}" />
                ...
                <div class="bb-card">
                    <div class="bb-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div class="d-flex align-items-center gap-2">
                            <h6 class="fw-bold mb-0"><i class="bi bi-list-ul me-2"></i>Daftar Menu F&B</h6>
                            <span class="bb-badge" style="background: rgba(245,158,11,0.1); color: #f59e0b;">{{ items.length }} Menu</span>
                        </div>
                        <div style="min-width: 200px;">
                            <input type="text" v-model="searchQuery" placeholder="Cari nama / kategori..." class="bb-input form-control-sm py-2" />
                        </div>
                    </div>
